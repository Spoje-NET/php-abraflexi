...
class Actions
{
     ...
     */
    public static string $version = '2026.3.11';
     ...
     * @var array<string, array<string, string>>
     */
    public static array $kontrolniHlaseniDph = [
        'new' => [
            'actionId' => 'new',
            'actionName' => 'Přidat',
            'needInstance' => 'false',
     ...
     * @var array<string, array<string, string>>
     */
    public static array $objektDoplnku = [
        'new' => [
            'actionId' => 'new',
            'actionName' => 'Přidat',
            'needInstance' => 'false',
     ...
     * @var array<string, array<string, string>>
     */
    public static array $pristupovePravo = [
        'new' => [
            'actionId' => 'new',
            'actionName' => 'Přidat',
            'needInstance' => 'false',
