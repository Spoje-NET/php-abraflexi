 ...
 * @copyright  (C) 2015-2026 Spoje.Net
 */
...
class Actions
{
 ...
 static public $radaSkladovyPohyb = [
  ...
  'delete' => [
    ...
    /**
     * Evidence rada-uplatneni-dane-zavazku (Dokladové řady - uplatnění daně - závazky) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $radaUplatneniDaneZavazku = [
  'new' => [
    'actionId' => 'new',
    'actionName' => 'Přidat',
    'needInstance' => 'false',
 ...
 static public $dokladKUhrade = [
  ...
  'odeslani-mailem' => [
    ...
    /**
     * Evidence doplnek (Doplněk) Actions.
     *
     * @var array<string,array<string,string>>
     */
 ...
 static public $insight = [
  ...
  'delete' => [
    ...
    /**
     * Evidence integrace (Integrace) Actions.
     *
     * @var array<string,array<string,string>>
     */
 ...
 static public $kontakt = [
  ...
  'delete' => [
    ...
    /**
     * Evidence kontrolni-hlaseni-dph (Kontrolní hlášení DPH) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $kontrolniHlaseniDph = [
  'new' => [
    'actionId' => 'new',
    'actionName' => 'Přidat',
    'needInstance' => 'false',
 ...
 static public $vazebniDoklad = [
  ...
  'delete' => [
    ...
    /**
     * Evidence neuhrazene-po-splatnosti (Neuhrazené po splatnosti) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $neuhrazenePoSplatnosti = [
  'lock' => [
    'actionId' => 'lock',
    'actionName' => 'Zamknout',
    'needInstance' => 'true',
  ...
  'delete' => [
    ...
    /**
     * Evidence neuhrazene-po-splatnosti-2 (Neuhrazené po splatnosti - uhrazené) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $neuhrazenePoSplatnosti2 = [
  'lock' => [
    'actionId' => 'lock',
    'actionName' => 'Zamknout',
    'needInstance' => 'true',
 ...
 static public $stromKoren = [
  ...
  'delete' => [
    ...
    /**
     * Evidence objekt-doplnku (Objekt doplňku) Actions.
     *
     * @var array<string,array<string,string>>
     */
 ...
 static public $smlouvaPolozka = [
  ...
  'delete' => [
    ...
    /**
     * Evidence uplatneni-dane-zavazku-polozka (Položky uplatnění daně - závazky) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $uplatneniDaneZavazkuPolozka = [
  'new' => [
    'actionId' => 'new',
    'actionName' => 'Přidat',
    'needInstance' => 'false',
 ...
 static public $prislustenstvi = [
  ...
  'delete' => [
    ...
    /**
     * Evidence pristupove-pravo (Přístupová práva) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $pristupovePravo = [
  'new' => [
    'actionId' => 'new',
    'actionName' => 'Přidat',
    'needInstance' => 'false',
 ...
 static public $saldoKDatu = [
  ...
  'delete' => [
    ...
    /**
     * Evidence typ-stavu-ceniku (Stavy položek ceníku) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $typStavuCeniku = [
  ...
  'delete' => [
    ...
    /**
     * Evidence stav-ceniku (Stavy položek ceníku) Actions.
     *
     * @var array<string,array<string,string>>
     */
 ...
 static public $typAktivity = [
  ...
  'delete' => [
    ...
    /**
     * Evidence typ-uplatneni-dane-zavazku (Typy uplatnění daně - závazky) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $typUplatneniDaneZavazku = [
  'new' => [
    'actionId' => 'new',
    'actionName' => 'Přidat',
    'needInstance' => 'false',
 ...
 static public $umisteniVeSkladuMistnost = [
  ...
  'delete' => [
    ...
    /**
     * Evidence uplatneni-dane-zavazku (Uplatnění daně - závazky) Actions.
     *
     * @var array<string,array<string,string>>
     */
 static public $uplatneniDaneZavazku = [
  'lock' => [
    'actionId' => 'lock',
    'actionName' => 'Zamknout',
    'needInstance' => 'true',
