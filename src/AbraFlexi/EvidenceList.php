 ...
 *
 * Generated: Tue, 31 Dec 2024 11:48:03 +0000 
...
class EvidenceList extends RO
{
 ...
 static public $evidences = [
  ...
  'typ-interniho-dokladu' => [
    ...
    'extIdSupported' => 'true',
    'dbName' => 'dTypDokl',
    'evidenceFilter' => 'Prodejka = false AND Zapocet = false AND (((IdUcetObdobiOd IS NULL OR IdUcetObdobiOd IN (3,1,2,4,5,19)) AND (IdUcetObdobiDo IS NULL OR IdUcetObdobiDo IN (21,8,19))) AND PlatiOd <= 2024 AND PlatiDo >= 2024) AND IdTypOrg = 1 AND Modul = \'INT\' AND TypDoklK NOT IN (\'typDokladu.skontoZtrata\',\'typDokladu.skontoZisk\')',
  ],
  'typ-leasingu' => [
