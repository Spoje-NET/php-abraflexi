 ...
 *
 * Generated: Tue, 09 Dec 2025 00:49:53 +0000 
 * From:      https://demo.flexibee.eu:5434
 *    
 * @author     Vítězslav Dvořák <vitex@arachne.cz>
 * @copyright  (C) 2016-2025 Spoje.Net
 */
...
class EvidenceList extends RO
{
 ...
 static public $evidences = [
  ...
  'rada-uplatneni-dane-zavazku' => [
    ...
    'extIdSupported' => 'false',
    'dbName' => 'dRady',
    'evidenceFilter' => '(PlatiOd <= 2025 AND PlatiDo >= 2025) AND Modul = \'TXZ\'',
    'findByCodeProperties' => 'kod',
  ],
  'rada-faktury-vydane' => [
  ...
  'predpis-zauctovani' => [
    ...
    'extIdSupported' => 'true',
    'dbName' => 'uTypUcOp',
    'evidenceFilter' => 'ModulTxp = false AND ((IdUcetObdobiOd IS NULL OR IdUcetObdobiOd IN (24,3,1,2,4,5,19,23)) AND (IdUcetObdobiDo IS NULL OR IdUcetObdobiDo IN (21,8,23)))',
    'findByCodeProperties' => 'kod',
  ],
  'faktura-prijata' => [
  ...
  'typ-uplatneni-dane-zavazku' => [
    ...
    'extIdSupported' => 'true',
    'dbName' => 'dTypDokl',
    'evidenceFilter' => 'Prodejka = false AND Zapocet = false AND (((IdUcetObdobiOd IS NULL OR IdUcetObdobiOd IN (24,3,1,2,4,5,19,23)) AND (IdUcetObdobiDo IS NULL OR IdUcetObdobiDo IN (21,8,23))) AND PlatiOd <= 2025 AND PlatiDo >= 2025) AND IdTypOrg = 1 AND Modul = \'TXZ\'',
    'findByCodeProperties' => 'kod',
  ],
  ...
  'cleneni-kontrolni-hlaseni' => [
    ...
    'evidenceFilter' => '(PlatiOd <= 2025 AND PlatiDo >= 2025) AND IdStatu IN (39,124,190)',
    'findByCodeProperties' => 'kod',
  ],
  'cleneni-dph' => [
