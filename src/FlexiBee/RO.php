...
/**
 * FlexiBee - Read Only Access to FlexiBee class.
 *
...
class RO extends \Ease\Sand {
     ...
     */
    public $defaultHttpHeaders = ['User-Agent' => 'FlexiBee'];
...
//Vždy nastavíme byť i prázná postdata jako ochranu před chybou 411
        ...
        foreach ($httpHeaders as $key => $value) {
            if (($key == 'User-Agent') && ($value == 'FlexiBee')) {
...
// Proveď samotnou operaci
    ...
    /**
     * Gives you FlexiBee class name for Given Evidence
     *
    ...
    public function getActionsInfo($evidence = null) {
        ...
        if (isset(\FlexiBee\Actions::$$propsName)) {
    ...
    public function getRelationsInfo($evidence = null) {
        ...
        $propsName = lcfirst(RO::evidenceToClassName($evidence));
        if (isset(\FlexiBee\Relations::$$propsName)) {
