...
class FakturaVydanaTest extends FlexiBeeRWTest
{
                                           ...
                                           $evidence = 'vydana')
    {
        ...
        $testCode  = 'TEST_'.time();
        $invoice   = new \FlexiBee\FakturaVydana(null,
        ...
        $invoice->takeData(array_merge([
            ...
            'bezPolozek' => true,
            'popis' => 'FlexiBee Test invoice',
            'datVyst' => \FlexiBee\RO::dateToFlexiDate($yesterday),
            'typDokl' => \FlexiBee\RO::code('FAKTURA')
                ], $initialData));
        if ($invoice->sync()) {
            $invoice->addStatusMessage($invoice->getApiURL().' '.\FlexiBee\RO::uncode($invoice->getDataValue('typDokl')).' '.\FlexiBee\RO::uncode($invoice->getRecordIdent()).' '.\FlexiBee\RO::uncode($invoice->getDataValue('sumCelkem')).' '.\FlexiBee\RO::uncode($invoice->getDataValue('mena')),
                'success');
        } else {
    ...
    /**
     * @covers FlexiBee\FakturaVydana::hotovostniUhrada
     */
    ...
    /**
     * @covers FlexiBee\FakturaVydana::sparujPlatbu
     */
    public function testsparujPlatbu()
    {
        $this->makeInvoice();
        $doklad     = new \FlexiBee\PokladniPohyb();
...
//                $invoiceData['sumCelkZakl']  = $invoiceData['castkaMen']    = 0;
    ...
    /**
     * @covers FlexiBee\FakturaVydana::odpocetZDD
     */
    ...
    /**
     * @covers FlexiBee\FakturaVydana::odpocetZalohy
     */
...
//        $this->assertEquals('true', $result['success'], 'Matching Error');
    ...
    /**
     * @covers FlexiBee\FakturaVydana::addArrayToBranch
     */
    ...
    /**
     * @covers FlexiBee\FakturaVydana::vytvorVazbuZDD
     */
    ...
    /**
     * @covers FlexiBee\FakturaVydana::overdueDays
     */
    public function testOverdueDays()
    {
        ...
        $this->assertEquals(14,
            FakturaVydana::overdueDays(\FlexiBee\RW::dateToFlexiDate($datVyst)));
    }
}
