...
class FlexiBeeRWTest extends FlexiBeeROTest
{
     ...
     * @var string 
     */
    public $poznam = 'Generováno UnitTestem PHP Knihovny https://github.com/Spoje-NET/FlexiBee';
        ...
        if (count($structure)) {
            if (array_key_exists('typDokl', $structure)) {
                if ($structure['typDokl']['type'] == 'relation') {
                    ...
                    $loader                   = new \FlexiBee\RO(null,
                        ['evidence' => $relatedEvidence]);
                    $typDoklRaw               = $loader->getColumnsFromFlexibee([
                        'kod'], ['limit' => 1]);
                    $dataForInsert['typDokl'] = \FlexiBee\RO::code($typDoklRaw[0]['kod']);
                }
            }
            ...
            if (array_key_exists('kod', $structure)) {
                $dataForInsert['kod'] = \FlexiBee\RO::uncode($this->object->getKod($code));
            }
        }
     ...
     * @covers FlexiBee\FlexiBeeRW::__construct
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::performAction
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::timestampToFlexiDate
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::timestampToFlexiDateTime
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::objectToID
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::getRecordID
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::controlMandatoryColumns
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::controlReadOnlyColumns
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::addArrayToBranch
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::addObjectToBranch
     */
    public function testAddObjectToBranch()
    {
        $this->object->addObjectToBranch(new \FlexiBee\FakturaVydanaPolozka(['nazev' => 'test']));
    }

    /**
     * @covers FlexiBee\FlexiBeeRW::vazbaAdd
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::vazbaDel
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::getJsonizedData
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::insertToFlexiBee
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::parseResponse
     */
        ...
        $responseDecoded = array(
            ...
            array(
                ...
                array(
                    ...
                    'ref' => '/c/FlexiBee/adresar/792',
                ),
                1 =>
                array(
                    'id' => '793',
                    'request-id' => 'EXT:APP:200',
                    'ref' => '/c/FlexiBee/adresar/793',
                ),
                2 =>
                array(
                    'id' => '794',
                    'request-id' => 'EXT:APP:300',
                    'ref' => '/c/FlexiBee/adresar/794',
                ),
                3 =>
                array(
                    'id' => '795',
                    'request-id' => 'EXT:APP:400',
                    'ref' => '/c/FlexiBee/adresar/795',
                ),
                4 =>
                array(
                    'id' => '830',
                    'request-id' => 'EXT:APP:500',
                    'ref' => '/c/FlexiBee/banka/830',
                ),
                5 =>
                array(
                    'id' => '28',
                    'ref' => '/c/FlexiBee/adresar-bankovni-ucet/28',
                ),
            ),
            )
        ;
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::assignResultIDs
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::extractResultIDs
     */
    public function testExtractResultIDs()
    {
        $resultInfo = array(
            ...
            array(
                'id' => '26',
                'ref' => '/c/FlexiBee/adresar-bankovni-ucet/26',
            ),
        );
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::getLastInsertedId
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::sendUnsent
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::deleteFromFlexiBee
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::takeData
     */
    ...
    /**
     * @after 
     * @covers FlexiBee\FlexiBeeRW::getDataForJSON
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::addExternalID
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::changeExternalID
     */
    ...
    /**
     * @covers FlexiBee\FlexiBeeRW::sync
     */
